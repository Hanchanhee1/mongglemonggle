...
![image.png](attachment:832820cf-bcc3-4911-9caa-504a2cb90ed3:image.png)
...
![image.png](attachment:33365bde-2616-48cf-a2a0-4aec6bd9e1b5:image.png)
...
- **문제**: 사용자가 회원탈퇴를 시도할 때, 회원탈퇴 오류가 발생했습니다. 오류 메시지를 확인해본 결과, **constraint 제약조건** 관련 오류가 발생하고 있었습니다. 구체적으로, **USERS 테이블**과 **CART 테이블** 간의 종속성 문제로 인해 해당 유저의 데이터를 삭제할 수 없었습니다.
    ...
    ![image.png](attachment:9c6527fd-7db6-4310-a876-607a597a3949:image.png)
...
- **해결 방법**:
    ...
    3. 이를 통해 **회원탈퇴 시 유저 데이터와 관련된 모든 데이터(CART 데이터 포함)**가 함께 삭제되도록 변경했습니다.
        ...
        ![image.png](attachment:e25f97dc-d5bd-4de1-b053-d4cfbf30b966:image.png)
